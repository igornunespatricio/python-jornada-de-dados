...
quality-classes:
	...
	-poetry run ruff check --select=E,F,W,B,SIM,N8,UP,COM8,PLR,ERA001,I --fix classes_*/ --output-format=concise
	@echo "🎨 Running Black..."
...
quality-classes-quick:
	@echo "🔍 Running Ruff on classes_* directories..."
	-poetry run ruff check --select=E,F,W,B,SIM,I --fix classes_*/ --output-format=concise
	@echo "🎨 Running Black..."
	-poetry run black classes_*/
